...
EXTERN float BHSeedMinCandidateSeparation;       // Phase 3+: not yet active
EXTERN int   BHSeedMaxPerPass;                   // Phase 3+: not yet active
EXTERN int   BHSeedRunEveryTimestep;             // run every sub-cycle timestep
EXTERN int   BHSeedRankingOrder;                 // Phase 3+: not yet active
...
EXTERN float BHAccretionNHStar;                  // cm^-3 boost threshold
EXTERN float BHAccretionBeta;                    // boost slope
EXTERN float BHAccretionAlphaMax;                // max hot boost
EXTERN float BHAccretionRadiativeEfficiency;     // epsilon_r for Eddington rate
