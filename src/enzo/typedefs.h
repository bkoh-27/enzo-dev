...
/* Particle attribute slot convention.
   ...
   Locked BH seeding + accretion metadata slots:
    ...
    19 = BHFormationMass
    20 = BHLastMdotActual
    21 = BHFeedbackEnergyReservoir
    22 = BHLastFeedbackRedshift
#else
     4 = BHSeedChannel
     5 = BHSeedRedshift
     6 = BHSeedPatchMass
    ...
    16 = BHFormationMass
    17 = BHLastMdotActual
    18 = BHFeedbackEnergyReservoir
    19 = BHLastFeedbackRedshift
    20 = BHCumulativeReservoirIn
    21 = BHCumulativeReservoirOut
#endif
*/
...
const int PARTICLE_ATTRIBUTE_BHACCR_LAST_MDOT_ACTUAL = 20;
const int PARTICLE_ATTRIBUTE_BHFDBK_ENERGY_RESERVOIR = 21;
const int PARTICLE_ATTRIBUTE_BHFDBK_LAST_REDSHIFT    = 22;
const int PARTICLE_ATTRIBUTE_BHACCR_LAST_MDOT_REALIZED = 23;
const int PARTICLE_ATTRIBUTE_BHFDBK_REQUIRED =
  PARTICLE_ATTRIBUTE_BHFDBK_LAST_REDSHIFT + 1;
#else
...
const int PARTICLE_ATTRIBUTE_BHACCR_LAST_MDOT_ACTUAL = 17;
const int PARTICLE_ATTRIBUTE_BHFDBK_ENERGY_RESERVOIR = 18;
const int PARTICLE_ATTRIBUTE_BHFDBK_LAST_REDSHIFT    = 19;
const int PARTICLE_ATTRIBUTE_BH_CUMUL_RESERVOIR_IN   = 20;
const int PARTICLE_ATTRIBUTE_BH_CUMUL_RESERVOIR_OUT  = 21;
const int PARTICLE_ATTRIBUTE_BHACCR_LAST_MDOT_REALIZED = 22;
const int PARTICLE_ATTRIBUTE_BHFDBK_REQUIRED =
  PARTICLE_ATTRIBUTE_BH_CUMUL_RESERVOIR_OUT + 1;
#endif
...
const int PARTICLE_ATTRIBUTE_BH_REQUIRED =
  ...
  ((PARTICLE_ATTRIBUTE_BHSEED_REQUIRED > PARTICLE_ATTRIBUTE_BHFDBK_REQUIRED) ?
   PARTICLE_ATTRIBUTE_BHSEED_REQUIRED : PARTICLE_ATTRIBUTE_BHFDBK_REQUIRED) :
  ((PARTICLE_ATTRIBUTE_BHACCR_REQUIRED > PARTICLE_ATTRIBUTE_BHFDBK_REQUIRED) ?
   PARTICLE_ATTRIBUTE_BHACCR_REQUIRED : PARTICLE_ATTRIBUTE_BHFDBK_REQUIRED);
